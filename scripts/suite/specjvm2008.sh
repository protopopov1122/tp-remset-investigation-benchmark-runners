...
export JAVA_OPTS="$JAVA_OPTS $(java_gc_log_flags $GC_LOGS/gc.log) $(jfr_flags $JFR_DIR) --add-exports=java.xml/jdk.xml.internal=ALL-UNNAMED"
export JAVA_OPTIONS="$JAVA_OPTIONS $(java_gc_log_flags $GC_LOGS/gc.log) $(jfr_flags $JFR_DIR) --add-exports=java.xml/jdk.xml.internal=ALL-UNNAMED"
export _JAVA_OPTIONS="$_JAVA_OPTIONS $(java_gc_log_flags $GC_LOGS/gc.log) $(jfr_flags $JFR_DIR) --add-exports=java.xml/jdk.xml.internal=ALL-UNNAMED"
