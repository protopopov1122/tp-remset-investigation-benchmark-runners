...
def run(args: List[str]):
    ...
    compiler_speed_plot = plot_results(compiler_speed, 'CompilerSpeed')
    dacapo_plot = plot_results(dacapo, 'DaCapo')
    dacapo_large_plot = plot_results(dacapo_large, 'DaCapo Large')
    dacapo_huge_plot = plot_results(dacapo_huge, 'DaCapo Huge')
    delay_inducer_plot = plot_results(delay_inducer, 'DelayInducer')
    jbb2005_plot = plot_results(jbb2005, 'jbb2005')
    optaplanner_plot = plot_results(optaplanner, 'Optaplanner')
    ...
    renaissance_plot = plot_results(renaissance, 'Renaissance')
    rubykon_plot = plot_results(rubykon, 'Rubykon')
    specjvm2008_plot = plot_results(specjvm2008, 'specjvm2008', figsize=(50, 10))
